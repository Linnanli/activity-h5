...
var webpackPro = merge(webpackCommon, {
    output: {
        filename: path.join('static', 'js/[name].[chunkhash:5].js'),
        chunkFilename: path.join('static', 'js/[name].[chunkhash:5].js')
    },
    module: {
    ...
    plugins: [
        ...
        new ExtractTextPlugin({
            filename: path.join('static', 'css/[name].[contenthash:5].css')
        }),
